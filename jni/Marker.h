...
public:
	...
	void CompareCorners(std::vector<Point<CvPoint2D64f> > &_marker_corners_img, int *orientation, double *error, int pointX, int pointY, double diameter); //TODO wtf :(  Squared);
	/** \brief Compares the marker corners with the previous match. 
	 */
