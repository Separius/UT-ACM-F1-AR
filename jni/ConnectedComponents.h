...
public :
	...
	*/
	...
	virtual void LabelSquares(cv::Mat image, int pointX, int pointY) = 0;

	bool CheckBorder(CvSeq* contour, int width, int height);
	bool ranaCheckBorder(CvSeq* contour, int width, int height);
...
public:
	...
	void LabelSquares(cv::Mat   image, int pointX, int pointY);
