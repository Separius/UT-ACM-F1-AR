...
bool Serialization::Output() {
	...
	//~ } else {
		...
		//~ //(*stream)<<(*node);
	//~ }
	std::cerr<<"Unexpected Call : Serialization::Output\n";
	return true;
}
...
bool Serialization::Input() {
	...
	//~ } else {
		...
		//~ //(*stream)>>(*node);
	//~ }
	std::cerr<<"Unexpected Call : Serialization::Input\n";
	return true;
}
...
bool Serialization::Descend(const char *id) {
	...
	//~ } else {
		...
		//~ }
	//~ }
	std::cerr<<"Unexpected Call : Serialization::Descend\n";
	return true;
}
bool Serialization::Ascend() {
	//~ SerializationFormatterXml *xml = (SerializationFormatterXml *)formatter_handle;
	//~ xml->xml_current = (TiXmlElement*)xml->xml_current->Parent();
	std::cerr<<"Unexpected Call : Serialization::Ascend\n";
	return true;
}
...
Serialization::Serialization(std::string _filename) {
	...
	std::cerr<<"Unexpected Call : Serialization::Serialization1\n";
}
...
Serialization::Serialization(std::basic_iostream<char> &_stream)
{
	...
	//~ formatter_handle = xml;
	//~ stream = &_stream;
	std::cerr<<"Unexpected Call : Serialization::Serialization2\n";
}
...
Serialization::Serialization(std::basic_istream<char> &_stream) {
	...
	//~ formatter_handle = xml;
	//~ stream = &_stream;
	std::cerr<<"Unexpected Call : Serialization::Serialization3\n";
}
...
Serialization::Serialization(std::basic_ostream<char> &_stream) {
	...
	//~ formatter_handle = xml;
	//~ stream = &_stream;
	std::cerr<<"Unexpected Call : Serialization::Serialization4\n";
}

Serialization::~Serialization() {
	//~ SerializationFormatterXml *xml = (SerializationFormatterXml *)formatter_handle;
	//~ delete xml;
	std::cerr<<"Unexpected Call : Serialization::~Serialization\n";
}
...
bool Serialization::Serialize(int &data, const std::string &name) {
	...
	//~ return ret;
	std::cerr<<"Unexpected Call : Serialization::Serialize1\n";
	return true;
}
...
bool Serialization::Serialize(unsigned short &data, const std::string &name) {
	...
	//~ data = i;
	//~ return ret;
	std::cerr<<"Unexpected Call : Serialization::Serialize2\n";
	return true;
}
...
bool Serialization::Serialize(unsigned long &data, const std::string &name) {
	...
	//~ data = i;
	//~ return ret;
	std::cerr<<"Unexpected Call : Serialization::Serialize3\n";
	return true;
}
...
bool Serialization::Serialize(double &data, const std::string &name) {
	...
	//~ return ret;
	std::cerr<<"Unexpected Call : Serialization::Serialize4\n";
	return true;
}
